  ...
  return (
    <StyledReviewmentPage vertical gap={20}>
      ...
      <Flex vertical>
        ...
        <div>
          • {i18n.t("review_rules6")}:
        </div>
        <div>• {i18n.t("review_rules7")};</div>
        <div>• {i18n.t("review_rules8")};</div>
        <div>
          • {i18n.t("review_rules9")};
        </div>
        <div>
          • {i18n.t("review_rules10")}.
        </div>
        <div>
          • {i18n.t("review_rules11")}.
        </div>
      </Flex>
      <div>
       {i18n.t("review_text3")}.
      ...
      <div>
        • {i18n.t("review_text10")}.
      </div>
      <Flex>
        <div>{i18n.t("review_chel")}</div>
        <div> {i18n.t("review_chel_definition")}</div>
      </Flex>
