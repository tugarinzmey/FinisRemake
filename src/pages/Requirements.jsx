    ...
    <StyledRequirementsPage gap={30}>
      <Flex vertical gap={20}>
        ...
        <Flex vertical gap={10}>
          ...
          <div>
            4a. {i18n.t("requir_text9")}.
          </div>
          <div>
            5. 
            <strong>
            {i18n.t("requir_text10_part1")}
            </strong>
          ...
          <div>
            6.{i18n.t("requir_text11")}.
          </div>
          <div>
            7. {i18n.t("requir_text12")}.
          </div>
          <div>
            8. {i18n.t("requir_text13_part1")}: 
            <strong>
            {i18n.t("requir_text13_part2")}.
            </strong>
          </div>
          <div>
            9. {i18n.t("requir_text14")}.
          </div>
          <div>
            10. {i18n.t("requir_text15")}.
          </div>
          <div>
            11. {i18n.t("requir_text16")}.
          </div>
          <div>
            12.{i18n.t("requir_text17")}.
          </div>
          <div>
            13.{i18n.t("requir_text18")}.
          </div>
          <div>
            14.{i18n.t("requir_text19_part1")} <strong>{i18n.t("requir_text19_part2")} </strong>{i18n.t("requir_text19_2")}
          </div>
          <div>
            15. {i18n.t("requir_text20_part1")} 
            <strong> {i18n.t("requir_text20_part2")} </strong>- {i18n.t("requir_text20_part3")}.
          </div>
          <div>
          ...
          <div>
          {i18n.t("requir_text22_part1")} <Link>{i18n.t("requir_text22_part2")}</Link>. {i18n.t("requir_text22_part3")}.
          </div>
          <div>
          {i18n.t("requir_text23")}.
          </div>
        </Flex>
      </Flex>
