  ...
  return (
    <PageWrapper vertical gap={20} align="center">
      ...
      <Flex vertical>
        ...
        <div>{i18n.t("chuvak_info")}</div>
        <div>{i18n.t("zam_chuvak1_info")}</div>
        <div>{i18n.t("zam_chuvak2_info")}</div>
        <div>{i18n.t("secretary_info")}</div>
      </Flex>
      <Divider />
      <Flex vertical>
        <div>{i18n.t("adres2")}</div>
